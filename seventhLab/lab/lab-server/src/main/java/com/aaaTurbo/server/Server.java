...
import com.aaaTurbo.server.database.DBLocalConnector;
...
public final class Server {
    ...
    private static void serverSetUP(DatagramChannel serverChannel) throws Exception {
        ...
        DBLocalConnector dbLocalConnector = new DBLocalConnector();
        DBManeger dbManeger = new DBManeger();
        RouteCollection mainCollection = new RouteCollection(dbManeger.loadCollection());
