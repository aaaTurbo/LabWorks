...
public class Route implements Comparable<Route> {
    ...
    public Route(String name, Coordinates coordinates, LocalDate creationDate, Location from, LocationOne to, Long distance, int ownerID) {
        this.name = name;
    ...
    public int compareTo(Route o) {
        return (int) (name.compareTo(o.name) + id - o.id);
    }
