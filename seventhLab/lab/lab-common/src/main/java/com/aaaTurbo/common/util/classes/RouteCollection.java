...
public class RouteCollection {
    private HashSet<Route> roadCollection;
    private ZonedDateTime creationDate;
    private final int rand = 2147483647;
    private int ident = (int) (Math.random() * rand);

    public RouteCollection(HashSet<Route> roadCollection) {
        this.roadCollection = roadCollection;
        this.creationDate = ZonedDateTime.now();
    }

    public void setRoadCollection(HashSet<Route> roadCollection) {
        this.roadCollection = roadCollection;
    }
     ...
     * @param id
     */
    public Route idSearch(long id) throws IOException {
