...
import interfaces.TellUrName;

public class Hero extends Human {

    static TellUrName tellUrName = new TellUrName() {
        @Override
        public void tellName(Hero hero) {
            System.out.println("Герой " + hero.getName() + " говорит: Привет, я " + hero.getName() + "!");
        }
    };

    public void introduce() {
        tellUrName.tellName(this);
    }

    public Hero(String name, int dnacode) throws NullPointerException {
        super(name, dnacode);
    }
